...
<input class="form-control" type="email" name="email" placeholder="Enter reg Email"required autocomplete="off" />
</div>

<div class="form-group">
<label>Reg Mobile No</label>
<input class="form-control" type="text" name="mobile" placeholder="Enter reg mobile no"required autocomplete="off" />
</div>

<div class="form-group">
<label>Password</label>
<input class="form-control" type="password" name="newpassword" placeholder="Password"required autocomplete="off"  />
</div>

...
$sql ="SELECT EmailId,Password,FullName,StudentId,Image ,Status FROM tblstudents WHERE EmailId=:email and Password=:password";
...
$_SESSION['fnamee']=$result->FullName;
$_SESSION['image']=$result->Image;
//echo '<script>alert("Your Registration successfull and your student id is  "+"'.$result->Image.'") </script>';
...
<input class="form-control" type="text" name="emailid" placeholder="Enter Email "required autocomplete="off" />
</div>
<div class="form-group">
